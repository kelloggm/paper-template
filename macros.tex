...
%    name contains unusual formatting, such as "IDE^{\mathit{al}}".  But it
%    is best to avoid such cuteness in tool names.
%  * If none of the above situations applies, then you might as well write
%    the tool name directly in the text, which is easier to read.  You can
%    do a trivial textual replacement if you rename the tool.  Spell-check
%    will tell you if you misspelled the name anywhere.
