...
% Text in \iflongversion...fi is rendered if the \createlongversion macro is defined.
\newif\iflongversion
...
\hyphenation{Deep-Seek}
\hyphenation{white-space}
\hyphenation{trans-piles trans-piler trans-pilers trans-pila-tion}
